...
const IntroSection = () => {
  return (
    <div className="w-full min-h-screen flex flex-col md:flex-row justify-center items-stretch md:px-24 px-6 md:py-24 py-8 gap-8 bg-[#f1f2f6] overflow-x-hidden">
      
      {/* Picture Section */}
      <div className="w-full md:w-1/3 h-[300px] flex items-start md:h-full">
        <img
          src="images/ali.jpg"
